      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            ...
            <motion.p
              className="text-lg lg:text-xl text-muted-foreground max-w-lg leading-relaxed mx-auto lg:mx-0"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.8 }}
            >
              <Button size="lg" className="designer-button px-8 py-4 lg:py-6 group" asChild>
                <Link href="/portfolio" className="flex items-center justify-center gap-2">
                  <span>View Our Solutions</span>
                  <ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="rounded-xl border-2 border-primary/20 hover:border-primary/50 backdrop-blur-sm px-8 py-4 lg:py-6 group" asChild>
